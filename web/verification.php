...
<div class="flex flex-wrap items-center">
    ...
    <div class="flex w-full pt-2 content-center justify-between md:w-1/3 md:justify-end">
        <ul class="list-reset flex justify-between flex-1 md:flex-none items-center">
            ...
            <li class="flex-1 md:flex-none md:mr-3">
            <a class="inline-block py-2 px-4 text-white no-underline" href="./capturePhoto.php"><i class="fa fa-camera"></i>Capture Photo</a>
            </li>
            <li class="flex-1 md:flex-none md:mr-3">
...
<div class="header">
    <div class="header-item">
        <a href="./capturePhoto.php"></a>
    </div>
</div>
<div class="verification-page">

<div class="form">
<h2 style="color=#32CD32">Verification</h2>
    ...
    <div >
        ...
        <button type="submit"  id="subButton">Verify</button>
    </form>
</div>
</div> 
</div>
